...
class FloatingReferencesPageController extends GetxController {
  ...
  @override
  void onReady() {
    FloatingBibleController floatingBiblePageController = Get.find();
    bookAutoScrollController!.scrollToIndex(floatingBiblePageController.bookNumber - 1, preferPosition: AutoScrollPosition.middle, duration: Duration(milliseconds: 500));
    chapterAutoScrollController!.scrollToIndex(floatingBiblePageController.chapterNumber - 1, preferPosition: AutoScrollPosition.middle, duration: Duration(milliseconds: 500));
    verseAutoScrollController!.scrollToIndex(floatingBiblePageController.verseNumber - 1, preferPosition: AutoScrollPosition.middle, duration: Duration(milliseconds: 500));
  ...
  void searchListItemOnTap(int index) async {
    ...
    Get.back();
    Get.back();
    floatingBiblePageController.setReferenceSafeScroll(searchList[index][0], searchList[index][1], searchList[index][2]);
  }
  ...
  void searchTextFieldOnSubmitted(String text){
    if(searchList.length > 0){
      ...
      Get.back();
      Get.back();
      floatingBiblePageController.setReferenceSafeScroll(searchList[0][0], searchList[0][1], searchList[0][2]);
    }
  }
}