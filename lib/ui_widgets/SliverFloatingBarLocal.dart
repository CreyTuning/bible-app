...
class SliverFloatingBarLocal extends StatefulWidget {
  /// Creates a material design app bar that can be placed in a [CustomScrollView].
  ///
  /// The arguments [forceElevated], [primary], [floating], [pinned], [snap]
  /// and [automaticallyImplyLeading] must not be null.
  const SliverFloatingBarLocal({
    Key key,
    this.leading,
  ...
  @override
  _SliverFloatingBarLocalState createState() => _SliverFloatingBarLocalState();
}

class _SliverFloatingBarLocalState extends State<SliverFloatingBarLocal>
  ...
  @override
  void didUpdateWidget(SliverFloatingBarLocal oldWidget) {
