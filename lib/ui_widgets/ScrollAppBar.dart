...
import 'ScrollAppBarController.dart';

class FloatingAppBar extends StatefulWidget with PreferredSizeWidget {
  FloatingAppBar({
    Key key,
...
class _FloatingAppBarState extends State<FloatingAppBar> {
  ...
  Widget _opacity(double heightFactor) {
    ...
    // Lo elimine para desactivar la opacidad y aumentar el rendimineto
    // return Opacity(
    //   opacity: Interval(
    //     0.4,
    //     1.0,
