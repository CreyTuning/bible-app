...
import 'package:yhwh/ui_widgets/scroll_bottom_navigation_bar_controller.dart';

class NewScrollBottomNavigationBar extends StatefulWidget {
...
class _ScrollBottomNavigationBarState extends State<NewScrollBottomNavigationBar> {
  ...
  Widget _opacity(double heightFactor) {
    ...
    // Eliminado para desactivar la opacidad y mejorar el rendimiento
    // return Opacity(
