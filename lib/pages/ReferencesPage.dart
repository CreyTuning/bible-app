                                  ...
                                  appBar: AppBar(
                                    ...
                                    title: TextField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText: 'Buscar',
                                        hintStyle: Theme.of(context).textTheme.bodyMedium!.copyWith(fontSize: 21),
                                      ),
                      ...
                      children: [
                        Expanded(
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Text("Libro", style: Theme.of(context).textTheme.bodyLarge!.copyWith(fontSize: 18), textAlign: TextAlign.center),
                            ),
                          ),
                        ),
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: Text("Capitulo", style: Theme.of(context).textTheme.bodyLarge!.copyWith(fontSize: 18), textAlign: TextAlign.center),
                          ),
                        ),
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: Text("Verso", style: Theme.of(context).textTheme.bodyLarge!.copyWith(fontSize: 18), textAlign: TextAlign.center),
                          ),
                        )
                      ],
                    ),
                                ...
                                return AutoScrollTag(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: index == controller.bookNumber - 1 ? Theme.of(context).textTheme.bodyLarge!.color: Colors.transparent,
                                        borderRadius: BorderRadius.only(topRight: Radius.circular(30), bottomRight: Radius.circular(30), bottomLeft: Radius.circular(6), topLeft: Radius.circular(6)),
                                      ),
                                      ...
                                      child: Text(
                                        ...
                                        maxLines: 1,
                                        style: Theme.of(context).textTheme.bodyLarge!.copyWith(
                                          color: index == controller.bookNumber - 1 ? Theme.of(context).canvasColor : Theme.of(context).indicatorColor,
                                          fontSize: 18,
                              ...
                              itemBuilder: (context, index) {
                                return AutoScrollTag(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                        color: index == controller.chapterNumber - 1 ? Theme.of(context).textTheme.bodyLarge!.color: Colors.transparent,
                                      ...
                                      child: Text(
                                        ...
                                        maxLines: 1,
                                        style: Theme.of(context).textTheme.bodyLarge!.copyWith(
                                          color: index == controller.chapterNumber - 1 ? Theme.of(context).canvasColor : Theme.of(context).textTheme.bodyLarge!.color,
                                          fontSize: 18,
                                          overflow: TextOverflow.ellipsis,
                                        ),
                                      )
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return AutoScrollTag(
                                  ...
                                  child: InkWell(
                                    ...
                                    child: Container(
                                      decoration: BoxDecoration(
                                        color: index == controller.verseNumber - 1 ? Theme.of(context).textTheme.bodyLarge!.color: Colors.transparent,
                                        shape: BoxShape.circle,
                                      ),
                                      alignment: Alignment.center,
                                      height: 60,
                                      child: Text(
                                        ...
                                        maxLines: 1,
                                        style: Theme.of(context).textTheme.bodyLarge!.copyWith(
                                          color: index == controller.verseNumber - 1 ? Theme.of(context).canvasColor : Theme.of(context).textTheme.bodyLarge!.color,
                                          fontSize: 18,
                                          overflow: TextOverflow.ellipsis,
                                        ),
                                      )
